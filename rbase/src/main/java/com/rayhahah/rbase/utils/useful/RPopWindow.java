 ...
 * 通用的PopupWindow
 */
public class RPopWindow  extends PopupWindow{
    ...
    private RPopWindow(Context context) {
    ...
    public static class Builder {
        ...
        public RPopWindow create() {
            final RPopWindow popupWindow = new RPopWindow(params.mContext);
