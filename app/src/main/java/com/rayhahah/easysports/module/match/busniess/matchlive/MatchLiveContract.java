...
public class MatchLiveContract {
    public interface IMatchLiveView extends IRBaseView {
        ...
        void getLiveDataSuccess(List<LiveDetail.LiveContent> detail, boolean front);

        void getLiveDataFailed(String message, boolean front);
    }

    public interface IMatchLivePresenter {

        void getLiveIndex(String mid);
        void getMoreContent(String mid);
    }
}
