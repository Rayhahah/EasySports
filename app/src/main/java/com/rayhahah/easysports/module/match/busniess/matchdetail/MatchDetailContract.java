...
public class MatchDetailContract {
    ...
    public interface IMatchDetailView extends IRBaseView {
        ...
        void getMatchDetailSuccess(MatchDetailBean data);

        void getMatchDetailFailed(String message);

        void initTabSuccess(ArrayList<String> tabTitles, ArrayList<BaseFragment> fragmentList);
    }

    public interface IMatchDetailPresenter {

        void getMatchDetail(String mid);

        void initTab(boolean isStart, String mId, MatchDetailBean.BaseInfo info);
    }
