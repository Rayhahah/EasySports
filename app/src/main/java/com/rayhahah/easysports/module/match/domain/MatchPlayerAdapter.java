 ...
 * @fuction
 */
public class MatchPlayerAdapter extends BaseQuickAdapter<MatchPlayer, BaseViewHolder> {
...
//        List<MatchStatusBean.PlayerStats> data = adapter.getData();
//        MatchStatusBean.PlayerStats playerStats = data.get(position);
//        RWebActivity.start(mContext, mActivity, playerStats.detailUrl, playerStats.row.get(0), true, true);
//    }
}
