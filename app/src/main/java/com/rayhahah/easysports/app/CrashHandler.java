...
import com.rayhahah.easysports.common.AppCrashMessage;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            RLog.e("CrashHandleran.NameNotFoundException---> error occured when collect package info", e);
        }
        ...
        for (Field field : fields) {
            try {
                ...
                RLog.e("CrashHandler.NameNotFoundException---> an error occured when collect crash info", e);
            }
        }
    }
