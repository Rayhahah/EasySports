...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    private playerClickListenr mPlayerClickListenr;
    ...
    public void init(Context context) {
        ...
        startImageView = ((ImageView) findViewById(R.id.start));
    ...
    public interface playerClickListenr {
        void onClick(View v);
    }

    public void setPlayerClick(playerClickListenr listenr) {
        mPlayerClickListenr = listenr;
    }
}
